...
simulations = 500;  %00; %000; %00; %50000; % number of Monte Carlo simulations
...
temporal_params.noise_sigma = 0.09; %0.001; %0.1;
...
global_vars.occlusion_blocs_cord(1,:) = [100,175];
...
overall_car_id__pre_occl_error = zeros(10,1);
overall_car_id_est1_error = zeros(10,1);
overall_car_id_est2_error = zeros(10,1);
overall_car_event_type_error = zeros(10,1);


overall_dist_error = struct;
overall_dist_error.run_num_1=Inf(simulations,1);
overall_dist_error.run_num_2=Inf(simulations,1);
overall_dist_error.run_num_3=Inf(simulations,1);
overall_dist_error.run_num_4=Inf(simulations,1);
overall_dist_error.run_num_5=Inf(simulations,1);
overall_dist_error.run_num_6=Inf(simulations,1);
overall_dist_error.run_num_7=Inf(simulations,1);
overall_dist_error.run_num_8=Inf(simulations,1);
overall_dist_error.run_num_9=Inf(simulations,1);
overall_dist_error.run_num_10=Inf(simulations,1);

% car_prediction1 = zeros(simulations, 8);
% car_prediction2 = zeros(simulations, 8);


car_prediction1 = zeros(simulations, 10);
car_prediction2 = zeros(simulations, 10);
...
%BASE run
% fprintf('\n\n\n============No chnage in num cars in Progress ...================\n');
% event.type=[];
% run_num=1;
% simulator_1d_v2;
...
% overall_car_id__pre_occl_error
% overall_car_event_type_error
% overall_car_id_est1_error
% 
% fprintf('\n\n\n=========1 car disappearance car 1 in Progress ...===============\n');
% event.type =[-1];
% event.occlusion_zone = [1];
% event.car_id = [1];
% run_num=2;
...
% 
% 
% fprintf('\n\n\n===========1 car disappearance car 2 in Progress ...==============\n');
% event.type =[-1];
% event.occlusion_zone = [1];
% event.car_id = [2];
% run_num=3;
...
% 
% 
% fprintf('\n\n\n============1 car disappearance car 3 in Progress ...=============\n');
% event.type =[-1];
% event.occlusion_zone = [1];
% event.car_id = [3];
% run_num=4;
...
% 
% 
% fprintf('\n\n\n============1 car appearance car 1 in Progress ...================\n');
% event.type =[1];
% event.occlusion_zone = [1];
% event.car_id = [1];
% run_num=5;
...
% 
% 
% fprintf('\n\n\n===========1 car appearance car 2 in Progress ...=================\n');
% event.type =[1];
% event.occlusion_zone = [1];
% event.car_id = [2];
% run_num=6;
...
% 
% 
% fprintf('\n\n\n=============1 car appearance car 3 in Progress ...===============\n');
% event.type =[1];
% event.occlusion_zone = [1];
% event.car_id = [3];
% run_num=7;
...
fprintf('\n\n\n=============1 car appearance car 4 in Progress ...===============\n');
event.type =[1];
event.occlusion_zone = [1];
event.car_id = [4];
run_num=8;
...
fprintf('\n\n\n=============1 car disappearance car 4 in Progress ...===============\n');
event.type =[-1];
event.occlusion_zone = [1];
event.car_id = [4];
run_num=9;
...
fprintf('\n\n\n=============1 car appearance car 5 in Progress ...===============\n');
event.type =[1];
event.occlusion_zone = [1];
event.car_id = [5];
run_num=10;
